  ...
  <div class="wrapper" @click="handleDocumentClick">
    <div class="sidebar">
      <font-awesome-icon
        ...
        class="main-icon"
      />
      <div v-show="showMainIconText" class="main-icon-text">
        Server hinzufügen
      </div>
      <div v-for="server in servers" :key="server.name" id="server-item">
        ...
        />
        <div
          v-show="server.showTooltip && !server.showContextMenu"
          class="server-tooltip"
        >
          {{ server.name }}
        </div>
        <div v-show="server.showContextMenu" class="server-context-menu">
          <span @click="editServerProfile(server)"
            >Serverprofil bearbeiten</span
          >
          <span
            class="removeServer"
    ...
    <div v-if="isModalOpen" class="modal" @click="closeServer">
      <div class="modal-content" @click.stop>
        ...
        <div class="bottomHalf">
          <span v-if="duplicateError" id="error-message"
            >Name bereits vorhanden</span
          >
          <button
            ref="saveButton"
